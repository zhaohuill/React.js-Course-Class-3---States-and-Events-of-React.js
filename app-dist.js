...
class Hello extends React.Component {
  ...
  render() {
    return /*#__PURE__*/React.createElement("h1", {
      onClick: () => this.sayGoodbye()
    }, "Hello ", this.state.name, "!") //(Para entender más de la Sintaxis JS dentro del Elemnto <h1> de aquí arriba, Véase JSON(Javascript Object Model) y "Programación en Javascript Orientada a Objetos".)
    ;
  }
...
ReactDOM.render( /*#__PURE__*/React.createElement(Hello, null), document.getElementById('p1'));
...
class Counter extends React.Component {
  ...
  render() {
    return /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("div", null, this.state.count), /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("a", {
      href: "#",
      onClick: () => this.upCount(),
      className: "btn btn-info"
    }, "Up"), /*#__PURE__*/React.createElement("a", {
      href: "#",
      onClick: () => this.downCount(),
      className: "btn btn-dark"
    }, "Down"), /*#__PURE__*/React.createElement("a", {
      href: "#",
...
ReactDOM.render( /*#__PURE__*/React.createElement(Counter, null), document.getElementById('p2'));
